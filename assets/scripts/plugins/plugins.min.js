	...
	$.fn.shareify.defaults = {
		providers: {
			facebook: {
				...
				button: '<a href="%url%" target="_blank"><i class="fa fa-fw fa-facebook"></i></a>'
			},
			twitter: {
				url: 'https://twitter.com/home?status=%title% %url%',
				button: '<a href="%url%" target="_blank"><i class="fa fa-fw fa-twitter"></i></a>'
			},
			google: {
				url: 'https://plus.google.com/share?url=%url%',
				button: '<a href="%url%" target="_blank"><i class="fa fa-fw fa-google"></i></a>'
			},
			pinterest: {
				url: 'https://pinterest.com/pin/create/button/?url=%url%&media=%image%&description=%title%',
				button: '<a href="%url%" target="_blank"><i class="fa fa-fw fa-pinterest"></i></a>'
			}
		},
		templates: {
